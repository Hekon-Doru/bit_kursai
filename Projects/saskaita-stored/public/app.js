...
var main = /*#__PURE__*/function (_StorageManager) {
  ...
  return _createClass(main, null, [{
    ...
    value: function handleCreateButtonClicks() {
      ...
      createButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var invoice;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
    ...
    value: function initEdit() {
      ...
      var saskaita = document.querySelector('[data-frame]'); // saskaita elementas 
