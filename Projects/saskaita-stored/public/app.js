...
var InvoiceCalculations = /*#__PURE__*/function () {
  ...
  return _createClass(InvoiceCalculations, [{
    ...
    value: function render() {
      ...
      var pvm = 0;
      var isViso = 0;
      var discountedSumWithQuantity = 0;
      var taxesAfterWithQuantity = 0;
      var totalWithTaxWithQuantity = 0;
      ...
      this.invoice.items.forEach(function (item) {
        ...
        var itemQuantityInput = clone.querySelector('[data-item-quantity]');
        ...
        var discountType = item.discount && item.discount.type ? item.discount.type : 'fixed';
...
var StorageManager = /*#__PURE__*/function () {
  ...
  return _createClass(StorageManager, null, [{
    ...
    value: function destroy(id) {
      this.write(this.read().filter(function (d) {
        return d.id != id;
      }));
    }
  }, {
    ...
    value: function update(id, data) {
      this.write(this.read().map(function (d) {
        return d.id == id ? _objectSpread(_objectSpread(_objectSpread({}, d), data), {}, {
          id: id
        }) : d;
      }));
    }
...
var main = /*#__PURE__*/function (_StorageManager) {
  ...
  return _createClass(main, null, [{
    ...
    value: function initDelete() {
      ...
      destroyButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
      ...
      cancelButton.addEventListener('click', function (_) {
    ...
    value: function initList() {
      ...
      invoices.forEach(function (activeInvoice) {
        ...
        clone.querySelector('[page-show]').href = "show.html#".concat(activeInvoice.id);
        clone.querySelector('[page-edit]').href = "edit.html#".concat(activeInvoice.id);
        clone.querySelector('[page-delete]').href = "delete.html#".concat(activeInvoice.id);
        listEl.appendChild(clone);
      });
    }
  }, {
    key: "handleCreateButtonClicks",
    value: function handleCreateButtonClicks() {
      var _this2 = this;
      var createButton = document.querySelector('[data-get]');
      createButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var invoice;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.n = 1;
              return _InvoiceAPI_js__WEBPACK_IMPORTED_MODULE_0__.InvoiceAPI.fetchInvoice();
            case 1:
              invoice = _context2.v;
    ...
    value: function initEdit() {
      ...
      saveButton.addEventListener('click', function (_) {
        ...
        invoice.items.forEach(function (item, index) {
          ...
          items.push(_objectSpread(_objectSpread({}, item), {}, {
            discount: discount
          }));
        });
